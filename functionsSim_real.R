...
#### that mimic the real data of gene-expression
###############################################################################
...
simula_real <- function(dorep, n, p, lambda = c(0, 100), lambda0 = c(0, 100), rho = 0, ncpus = 50L, B = 1000, penalty = function(n,p) log(n) + 0.5*log(p), ident = TRUE, file.name = "", mc.cores = 1, ty, mu0 = NA, sigma0 = NA, pmiss0 = NA, mu1 = NA, sigma1 = NA, pmiss1 = NA) {
...
simula.internal_real <- function(i, n, p, lambda = c(0, 100), lambda0 = c(0, 100), rho = 0, ncpus = 1, B = 1000, penalty = function(n,p) log(n) + 0.5*log(p), ident = TRUE, file.name = "", temp = TRUE, ty, mu0 = NA, sigma0 = NA, pmiss0 = NA, mu1 = NA, sigma1 = NA, pmiss1 = NA) {
    # set the seed
    set.seed(1235+i)
