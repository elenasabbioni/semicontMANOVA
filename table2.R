...
table2 <- df[, c("c1", "c2", "pmiss10.50", "rho10.50", "lambda10.50", "lambda10.100", "lambda10.150", "lambda10.200", "lambda20.50", "lambda20.100", "lambda20.150",  "lambda20.200")]
table2 <- rbind(c(rep("", 4), rep("n = 10", 4), rep("n = 20", 4)), table2)
colnames(table2) <- c("$c_1$", "$c_2$",  "$\\pi_{j1}$", "$\\rho$",rep(c("$p = 50$", "$p = 100$", "$p = 150$", "$p = 200$"), 2))
  
print(xtable(table2, digits=c(0, 0, 2, 1, 1, NA, NA, NA, NA, NA, NA, NA, NA)), include.rownames = FALSE)
